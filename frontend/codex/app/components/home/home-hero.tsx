  ...
  return (
    <section className="mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center px-6 py-10 sm:px-10 lg:px-12 lg:py-16">
      <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        ...
        <div className="grid gap-4 rounded-[2rem] border border-border bg-surface p-4 shadow-[0_30px_80px_rgba(23,19,18,0.12)] sm:p-6">
          <div className="rounded-[1.5rem] border border-border bg-[linear-gradient(135deg,var(--surface),var(--surface-muted))] p-6">
